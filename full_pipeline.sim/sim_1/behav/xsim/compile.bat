...
REM
REM Generated by Vivado on Thu Jul 30 23:53:57 -0400 2026
...
echo "xvlog --incr --relax -prj image_comparison_tb_vlog.prj"
call xvlog  --incr --relax -prj image_comparison_tb_vlog.prj -log xvlog.log
